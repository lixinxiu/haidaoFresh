...
#import "GeRenZhongXinView.h"

@interface GeRenZhongXinView ()

@end

@implementation GeRenZhongXinView
...
- (void)viewDidLoad {
    ...
    NSURL *storeURL;
    storeURL=[[NSURL alloc]initWithString:@"http://www.haidaofresh.com/hdsx/mobile/user.php"];
...
-(void)rollbutton
{
    ...
    [_btn setTitle:@"back" forState:UIControlStateDisabled];
